...
//
//     Generated on 2018-10-02T14:16:09, by ESR Version 1.82.0.0 using ESR Database SWS_EA_ESR_Cloud_Prod
//  </auto-generated>
// ------------------------------------------------------------------------------
    ...
    public partial class PAYEVNTEMP2018ValidatorSubmit
    {
        ...
        public List<ProcessMessageDocument> ValidateReport(PAYEVNTEMP2018 report)
        {
            ...
            */
            ...
            ^PAYEVNTEMP128 = PAYEVNTEMP:Payee:Onboarding:Declaration:Declaration.Signature.Date
            */
            ...
            */
            ...
            ^PAYEVNTEMP129 = PAYEVNTEMP:Payee:Onboarding:Declaration:Declaration.StatementAccepted.Indicator
    
            ^PAYEVNTEMP96 = PAYEVNTEMP:Payee:Onboarding:TFND:PaymentArrangement.PaymentBasis.Code
    
            ^PAYEVNTEMP98 = PAYEVNTEMP:Payee:Onboarding:TFND:TaxOffsetClaim.TaxFreeThreshold.Indicator
    
            ^PAYEVNTEMP106 = PAYEVNTEMP:Payee:Onboarding:TFND:StudentLoan.StudentFinancialSupplementScheme.Indicator
    
            ^PAYEVNTEMP128 = PAYEVNTEMP:Payee:Onboarding:Declaration:Declaration.Signature.Date
    
            ^PAYEVNTEMP202 = PAYEVNTEMP:Payee:Onboarding:TFND:Residency.TaxPurposesPersonStatus.Code
    
            ^PAYEVNTEMP241 = PAYEVNTEMP:Payee:Onboarding:TFND:IncomeTax.PayAsYouGoWithholding.StudyAndTrainingLoanRepayment.Indicator
            */
            ...
            if (assertion)
            {
                ...
                processMessage.Parameters.Add(new ProcessMessageParameter
                { Name = "PAYEVNTEMP96", Value = GetValueOrEmpty(report.PAYEVNTEMP96) });

                processMessage.Parameters.Add(new ProcessMessageParameter
                { Name = "PAYEVNTEMP202", Value = GetValueOrEmpty(report.PAYEVNTEMP202) });
